...
var HUD = {
  ...
  new: func(placement)
  {
    ...
    #######################
    var filename = "Aircraft/T-50/Models/HUD.svg";
...
#    # Remaining LEG/Nav distance
	...
	radar_on 			 	 :	"instrumentation/N010-radar/emitting",
...
#   not sure why the coordinates are in this order but are top,right,bottom,left (ys, xe, ye, xs)
  ...
  {
  var HudPower = 8;
  var hudSwitch = getprop("controls/switches/ILS-31HUD") or 1;
...
var init = setlistener("/sim/signals/fdm-initialized", func() {
  ...
  var hud_pilot = HUD.new({"node": "hud-glass"});
  hud_pilot.update();
});
